...
//@ts-ignore
const CitiesContext: Context<CitiesContextType> = createContext();
...
export function useCities(): CitiesContextType {
  const context = useContext(CitiesContext);
  if (context === undefined)
    throw new Error("this context has been used outside CitiesProvider");
  return {
